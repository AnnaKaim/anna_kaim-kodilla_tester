...
public class Stamp {
    ...
    public boolean equals(Object o) {
        ...
        Stamp stamp = (Stamp) o;
        return Double.compare(stamp.stampLength, stampLength) == 0 && Double.compare(stamp.stampWidth, stampWidth) == 0 && stamped == stamp.stamped && Objects.equals(stampName, stamp.stampName);
    }
