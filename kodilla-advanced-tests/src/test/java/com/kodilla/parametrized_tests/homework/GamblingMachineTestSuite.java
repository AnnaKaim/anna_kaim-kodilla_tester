...
public class GamblingMachineTestSuite {
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/validNumbersToGambling.csv", numLinesToSkip = 1)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/invalidNumbersToGambling.csv", numLinesToSkip = 1)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/invalidNumbersToGamblingWithLessNumbers.csv", numLinesToSkip = 1)
    ...
    @ParameterizedTest
    @CsvFileSource(resources = "/invalidNumbersToGamblingWithMoreNumbers.csv", numLinesToSkip = 1)
